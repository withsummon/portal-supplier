...
const PRESETS = [
    { id: 'llm', label: 'LLM Deployment', icon: Zap, unit: 'tokens/month', min: 1, max: 100, step: 1, suffix: 'M', basePrice: 800, color: 'var(--blue-500)' },
    { id: 'users', label: 'Active Users', icon: Users, unit: 'concurrent users', min: 100, max: 10000, step: 100, suffix: '', basePrice: 2, color: 'var(--color-success)' },
    { id: 'data', label: 'Data Volume', icon: Database, unit: 'GB/day', min: 10, max: 1000, step: 10, suffix: '', basePrice: 15, color: 'var(--color-purple)' },
];
        ...
        <div className="card" style={{ marginTop: 'var(--sp-8)' }}>
            <div className="card-header">
                ...
                <div style={{
                    ...
                    background: 'var(--neutral-100)', padding: '2px 10px',
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 260px', gap: 'var(--sp-8)' }}>
                                ...
                                <div key={preset.id}>
                                    ...
                                    <div style={{ position: 'relative' }}>
                                        <input
                                            ...
                                            step={preset.step}
                                            value={val}
                                            onChange={(e) => setValues(p => ({ ...p, [preset.id]: Number(e.target.value) }))}
                                    ...
                                    <div style={{
                                        ...
                                        <span>{preset.min.toLocaleString()}{preset.suffix}</span>
                                        <span>{preset.max.toLocaleString()}{preset.suffix}</span>
                                    </div>
                                </div>
                            );
                        })}
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            letterSpacing: '0.1em', opacity: 0.6, marginBottom: 'var(--sp-3)',
                        }}>
                        ...
                        <div style={{
                            fontSize: 'var(--fs-xs)', opacity: 0.5,

...
import { Search, FolderOpen, BookOpen, Cpu, ArrowRight, Command } from 'lucide-react';
import { mockProjects } from '@/lib/mock-data';

const RESEARCH_ARTICLES = [
    { title: 'The State of AI Transformation in Enterprise 2024', slug: 'ai-transformation-enterprise-2024' },
    ...
    { title: 'Scalable Data Architectures for Multi-tenant Systems', slug: 'scalable-data-architectures' },
    { title: 'Case Study: AI-Powered Supply Chain for GoTo Group', slug: 'case-study-goto-supply-chain' },
...
export default function CommandBar() {
    ...
    const getIcon = (type: string) => {
        switch (type) {
            case 'project': return <FolderOpen size={15} style={{ color: 'var(--blue-600)' }} />;
            case 'research': return <BookOpen size={15} style={{ color: 'var(--color-purple)' }} />;
            case 'factory': return <Cpu size={15} style={{ color: 'var(--color-success)' }} />;
                    ...
                    <div className="command-bar-results">
                        {results.length > 0 ? (
                            results.map((r, i) => (
                                ...
                                >
                                    <div className="command-bar-item-icon">
                                        {getIcon(r.type)}
                                    </div>
                            ...
                            <div className="command-bar-empty">
                                <Search size={20} style={{ color: 'var(--text-muted)', marginBottom: 'var(--sp-2)' }} />

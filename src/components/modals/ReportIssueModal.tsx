        ...
        <div style={{ marginBottom: 'var(--sp-6)' }}>
          ...
          >
            ...
            <p style={{ fontSize: 'var(--fs-sm)', color: 'var(--blue-800)' }}>
              Connect with our user support expert on Telegram.{' '}
              <a
                href="#"
                style={{
                  color: 'var(--blue-600)',
        ...
        >
          <div className="form-group">
            <label className="form-label">
              Your involvement on Summon <span className="form-required">*</span>
            </label>
          ...
          <div className="form-group">
            <label className="form-label">
              Describe the issue <span className="form-required">*</span>
            </label>
            <textarea

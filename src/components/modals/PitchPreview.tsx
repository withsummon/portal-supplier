            ...
            >
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        letterSpacing: '0.1em', opacity: 0.7, marginBottom: 'var(--sp-2)',
                    }}>
                    ...
                    <div style={{
                        display: 'flex', gap: 'var(--sp-3)', marginTop: 'var(--sp-5)',
                    }}>
                        <button className="btn" style={{
                            background: 'white', color: 'var(--blue-700)',
                            fontWeight: 600, gap: '6px', border: 'none',
                        }}>
                            <Download size={14} /> Download PDF
                        </button>
                        <button className="btn" style={{
                            background: 'rgba(255,255,255,0.15)', color: 'white',
                            fontWeight: 600, gap: '6px', border: '1px solid rgba(255,255,255,0.3)',
                        }}>
                ...
                <div style={{ padding: 'var(--sp-8)' }}>
                    ...
                    <div style={{ marginBottom: 'var(--sp-8)' }}>
                        <h3 style={{
                            fontSize: 'var(--fs-xs)', textTransform: 'uppercase',
                            letterSpacing: '0.06em', color: 'var(--text-muted)',
                            fontWeight: 700, marginBottom: 'var(--sp-4)',
                        }}>
                            Key Capabilities
                        </h3>
                    ...
                    {/* Footer Branding */}
                    <div style={{
                        marginTop: 'var(--sp-8)', textAlign: 'center',
                        paddingTop: 'var(--sp-5)', borderTop: '1px solid var(--border-default)',
                    }}>
                        <div style={{

...
import { Eye, EyeOff, CheckCircle, Zap, Shield, TrendingUp, Building2, Users, ShieldCheck } from 'lucide-react';
        ...
        <div className="auth-layout">
            ...
            <div className="auth-panel">
                ...
                <div className="auth-form animate-in">
                    ...
                    <div className="auth-fields">
                        <div className="form-group">
                            ...
                            <input
                                ...
                                defaultValue={selectedRole === 'admin' ? 'admin@withsummon.com' : 'budi@aryateknologi.co.id'}
                            />
                            {selectedRole === 'admin' && (
                    ...
                    <Link href={selectedRole === 'admin' ? '/admin' : selectedRole === 'vendor' ? '/vendor' : '/dashboard'} style={{ display: 'block', width: '100%' }}>

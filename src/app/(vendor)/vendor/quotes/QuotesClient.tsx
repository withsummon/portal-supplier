...
export default function MyQuotesPage({ quotes }: Props) {
    ...
    const stats = [
        ...
        { label: "Pending", value: quotes.filter((q) => q.status === "pending").length, icon: AlertCircle, color: "var(--color-warning)" },
        { label: "Won", value: quotes.filter((q) => q.status === "accepted").length, icon: CheckCircle, color: "var(--color-success)" },
        { label: "Rejected", value: quotes.filter((q) => q.status === "rejected").length, icon: XCircle, color: "var(--color-danger)" },
    ];
                        ...
                        <tbody>
                            {filteredQuotes.map((quote) => (
                                <tr key={quote.id}>
                                    ...
                                    <td>
                                        <StatusBadge status={quote.status as "pending" | "accepted" | "rejected" | "withdrawn"} type="quote" />
                                    </td>

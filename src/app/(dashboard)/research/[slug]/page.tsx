...
const ARTICLES: Record<string, {
    ...
    'ai-transformation-enterprise-2024': {
        ...
        subtitle: 'Our latest research reveals that while 85% of companies have started AI pilots, only 15% have achieved scale.',
    ...
    'security-framework-llms': {
        ...
        subtitle: 'Large language models introduce novel attack surfaces. A practical security framework for production deployments.',
    ...
    'future-computer-vision': {
        ...
        subtitle: 'How leading manufacturers are deploying computer vision for quality control, predictive maintenance, and beyond.',
    ...
    'scalable-data-architectures': {
        ...
        subtitle: 'A deep dive into modern data architectures that support multi-tenancy at scale while maintaining isolation.',
        category: 'Technology Trends',
    ...
    'case-study-goto-supply-chain': {
        ...
        subtitle: 'How Summon helped GoTo Group reduce delivery times by 23% through intelligent route optimization.',
    ...
    'ai-governance-sea': {
        ...
        subtitle: 'A comprehensive guide to AI regulation across ASEAN nations for enterprise deployments.',
        category: 'Industry Insights',
        author: 'Dr. Sarah Tan',
    ...
    'rag-vs-fine-tuning': {
        ...
        subtitle: 'Retrieval-augmented generation and fine-tuning solve different problems. We compare cost, accuracy, and latency.',
        category: 'AI & Machine Learning',
        author: 'Dr. Michael Chen',
        role: 'Chief AI Strategist',
    ...
    'case-study-mandiri-fraud': {
        ...
        subtitle: 'How Summon Sentinel reduced false positive rates by 40% while catching 99.7% of fraudulent transactions.',
        category: 'Case Studies',
    ...
    if (!article) {
        return (
            <div className="animate-in" style={{ textAlign: 'center', padding: 'var(--sp-16)' }}>
                <h1 style={{ fontSize: 'var(--fs-3xl)', fontWeight: 'var(--fw-bold)', marginBottom: 'var(--sp-4)' }}>Article Not Found</h1>
                <p style={{ color: 'var(--text-secondary)', marginBottom: 'var(--sp-6)' }}>The article you&apos;re looking for doesn&apos;t exist or has been moved.</p>
                <Link href="/research" className="btn btn-primary">← Back to Research</Link>
            </div>
        );
    }
            ...
            <div style={{ maxWidth: '900px' }}>
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--sp-2)' }}>
                        ...
                        <div>
                            <div style={{ fontWeight: 'var(--fw-semibold)', fontSize: 'var(--fs-sm)' }}>{article.author}</div>
                            <div style={{ fontSize: 'var(--fs-xs)', color: 'var(--text-muted)' }}>{article.role}</div>
                        </div>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--sp-2)', fontSize: 'var(--fs-sm)', color: 'var(--text-muted)' }}>
                        <Calendar size={16} />
                    ...
                    <div style={{ marginLeft: 'auto', display: 'flex', gap: 'var(--sp-2)' }}>
                        <button className="btn btn-ghost btn-sm" title="Share"><Share2 size={15} /></button>
                        <button className="btn btn-ghost btn-sm" title="Print"><Printer size={15} /></button>
                        <button className="btn btn-ghost btn-sm" title="Download PDF"><Download size={15} /></button>
                        <button className="btn btn-ghost btn-sm" title="Save"><Bookmark size={15} /></button>
                    </div>
                </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 260px', gap: 'var(--sp-10)' }}>
                    ...
                    <div>
                        ...
                        <div style={{
                            ...
                            <h3 style={{ fontSize: 'var(--fs-xl)', fontWeight: 'var(--fw-bold)', marginBottom: 'var(--sp-2)' }}>
                            ...
                            <button className="btn btn-primary" style={{ background: 'white', color: 'var(--blue-600)', borderColor: 'white' }}>
                                <Download size={15} />
                                Download PDF
                            </button>
                        </div>

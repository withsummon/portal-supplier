...
const ARTICLES = [
  {
    ...
    excerpt:
      'Our latest research reveals that while 85% of companies have started AI pilots, only 15% have achieved scale. Learn the 5 pillars of successful AI transformation.',
  ...
  },
  {
    ...
    readTime: '8 min read',
    excerpt:
      'Large language models introduce new attack surfaces. We break down a practical security framework for production LLM deployments.',
  ...
  },
  {
    ...
    excerpt:
      'How leading manufacturers are deploying computer vision for quality control, predictive maintenance, and supply chain optimization.',
  ...
  },
  {
    ...
    excerpt:
      'A deep dive into modern data architectures that support multi-tenancy at scale while maintaining isolation and performance.',
  ...
  },
  {
    ...
    readTime: '6 min read',
    excerpt:
      'How Summon helped GoTo Group reduce delivery times by 23% through intelligent route optimization and demand forecasting.',
  ...
  },
  {
    ...
    excerpt:
      'A comprehensive guide to AI regulation across ASEAN nations. What enterprises need to know before deploying AI solutions.',
    cover: '/assets/research/cover-1.png',
  },
  {
    ...
    readTime: '9 min read',
    excerpt:
      'Retrieval-augmented generation and fine-tuning solve different problems. We compare cost, accuracy, and latency tradeoffs.',
    cover: '/assets/research/cover-2.png',
  },
  {
    ...
    readTime: '7 min read',
    excerpt:
      "How Summon Sentinel reduced false positive rates by 40% while catching 99.7% of fraudulent transactions for Indonesia's largest bank.",
    cover: '/assets/research/cover-3.png',
  },
]
...
export default function ResearchBlog() {
  ...
  return (
    <div className="animate-in">
      ...
      >
        {activeCategory === 'All' ? 'All Insights' : activeCategory} — {filtered.length}{' '}

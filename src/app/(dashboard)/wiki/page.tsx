    ...
    <div className="animate-in">
      <div style={{ marginBottom: 'var(--sp-8)' }}>
        ...
        <p style={{ color: 'var(--text-secondary)' }}>
          Welcome to the knowledge hub. Find articles and guides to help you use the portal
          effectively.
        </p>
      </div>
              ...
              {mostRead.map((item, idx) => (
                <div
                  ...
                  style={{
                    ...
                    justifyContent: 'space-between',
                    borderBottom:
                      idx === mostRead.length - 1 ? 'none' : '1px solid var(--border-default)',
                    cursor: 'pointer',
                  }}
              ...
              {mostUseful.map((item, idx) => (
                <div
                  ...
                  style={{
                    ...
                    justifyContent: 'space-between',
                    borderBottom:
                      idx === mostUseful.length - 1 ? 'none' : '1px solid var(--border-default)',
                    cursor: 'pointer',
                  }}
                  className="sidebar-item"
                >
      ...
      >
        ...
        <p style={{ opacity: 0.8, marginBottom: 'var(--sp-6)' }}>
          Our support team is available 24/7 to help you with any platform issues.
        </p>
        <button
          className="btn btn-primary btn-lg"
          style={{ background: 'white', color: 'var(--blue-900)', border: 'none' }}
        >
          Contact Support
        </button>
      </div>
